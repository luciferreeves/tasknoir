...
const EditProjectPage: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{project ? `Edit: ${project.title}` : 'Edit Project'} | Task Management</title>
                <meta name="description" content={project ? `Edit project: ${project.title}` : 'Edit project details'} />
            </Head>
            <div className="min-h-screen bg-background">
                <Navbar />
                <div className="container mx-auto px-4 py-8">
